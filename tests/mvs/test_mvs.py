...
@patch("learned_sfm_mvs.mvs.dense_reconstruction.pycolmap.has_cuda", True)
@patch("learned_sfm_mvs.mvs.dense_reconstruction.pycolmap.patch_match_stereo")
@patch("learned_sfm_mvs.mvs.dense_reconstruction.pycolmap.PatchMatchOptions")
@patch("learned_sfm_mvs.mvs.dense_reconstruction.pycolmap.undistort_images")
